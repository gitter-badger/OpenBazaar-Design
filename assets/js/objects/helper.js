...
window.Helper = {
  ...
  setDefualtColors: function setDefualtColors(instant){
    if (instant){
      ...
      $('.modal-pretty tbody td').css('border-color', defaultSecondaryColor); 
      $('#header, .user-page-navigation, .item-meta-data, thead tr, .modal-footer, .modal-footer button').css('background', defaultSecondaryColor); 
      ...
      $('.user-page-navigation li, .button-first').css('border-color', defaultPrimaryColor); 
      $('.modal-pretty tbody td').css('border-color', defaultSecondaryColor); 
      $('#header, .user-page-navigation, .item-meta-data, thead tr, .modal-footer, .modal-footer button').animate({ backgroundColor: defaultSecondaryColor }, fade);  
